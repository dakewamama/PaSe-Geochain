...
var getClusterUrl = function getClusterUrl(config) {
  ...
  return web3_js.clusterApiUrl(config.cluster);
};
var makeTransaction = /*#__PURE__*/function () {
  var _ref2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(connection, fromPubkey, toPubkey, amount) {
    var instruction, blockhashWithExpiryBlockHeight;
    return runtime_1.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            blockhashWithExpiryBlockHeight = _context2.sent;
            return _context2.abrupt("return", new web3_js.Transaction(_extends({
              feePayer: fromPubkey
            }, blockhashWithExpiryBlockHeight)).add(instruction));
    ...
    return runtime_1.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            return _context3.abrupt("return", connection.isBlockhashValid(blockhash, {
              commitment: 'confirmed'
...
var instructionsToFilter = ['ComputeBudget111111111111111111111111111111'];
var checkTransactionParameters = function checkTransactionParameters(transaction) {
  console.log('instructions program ids', transaction.instructions.map(function (instruction) {
    return instruction.programId.toBase58();
  }));
  var filteredInstructions = transaction.instructions.filter(function (instruction) {
    return !instructionsToFilter.includes(instruction.programId.toBase58());
  });
  if (filteredInstructions.length !== 1) throw new Error('Incorrect instruction count. The transaction must contain only one Transfer instruction');
  var instruction = filteredInstructions[0];
  var transferParams;

  try {
    transferParams = web3_js.SystemInstruction.decodeTransfer(instruction);
  } catch (error) {
    console.log(error);
...
var create = /*#__PURE__*/function () {
  var _ref = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(signMessage, message) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            return _context.abrupt("return", "" + signatureB64);
...
var verify = function verify(publicKey, signature, message) {
  var decodedSignature = Buffer.from(signature, 'base64');
  var decodedMessage = Buffer.from(message);
  var verified = nacl.sign.detached.verify(decodedMessage, decodedSignature, publicKey.toBytes());
...
var proveTransaction = /*#__PURE__*/function () {
  var _ref2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(key, signer, config) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            connection = config.connection || new web3_js.Connection(getClusterUrl(config), config.commitment);
          ...
          case 13:
            ...
            return _context2.abrupt("return", signedTransaction.serialize());
  ...
  return function proveTransaction(_x3, _x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();
var verifyStatic = function verifyStatic(evidence, publicKey) {
  var transaction = web3_js.Transaction.from(evidence);
  checkSignatures(transaction, publicKey);
  checkTransactionParameters(transaction);
};
var verifyTransaction = /*#__PURE__*/function () {
  var _ref3 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3(evidence, publicKey, config) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            transaction = web3_js.Transaction.from(evidence);
            connection = config.connection || new web3_js.Connection(getClusterUrl(config), config.commitment);
  ...
  return function verifyTransaction(_x6, _x7, _x8) {
    return _ref3.apply(this, arguments);
  };
}();
...
exports.proveTransaction = proveTransaction;
exports.verify = verify;
exports.verifyStatic = verifyStatic;
exports.verifyTransaction = verifyTransaction;
//# sourceMappingURL=prove-solana-wallet.cjs.development.js.map
