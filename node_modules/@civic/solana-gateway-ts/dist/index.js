 ...
 */
const findGatewayTokens = (connection_1, owner_1, gatekeeperNetwork_1, ...args_1) => __awaiter(void 0, [connection_1, owner_1, gatekeeperNetwork_1, ...args_1], void 0, function* (connection, owner, gatekeeperNetwork, includeRevoked = false, page) {
 ...
 * @param page
 */
const findGatewayTokensForOwnerAndNetwork = (connection_2, owner_2, gatekeeperNetwork_2, ...args_2) => __awaiter(void 0, [connection_2, owner_2, gatekeeperNetwork_2, ...args_2], void 0, function* (connection, owner, gatekeeperNetwork, includeRevoked = false, offset = 0, page = 5) {
    const addresses = yield Promise.all(Array.from({ length: page }, (_, index) => (0, util_1.getGatewayTokenAddressForOwnerAndGatekeeperNetwork)(owner, gatekeeperNetwork, index + offset)));
 ...
 */
const findGatewayToken = (connection_3, owner_3, gatekeeperNetwork_3, ...args_3) => __awaiter(void 0, [connection_3, owner_3, gatekeeperNetwork_3, ...args_3], void 0, function* (connection, owner, gatekeeperNetwork, includeRevoked = false) {
    const gatewayTokens = yield (0, exports.findGatewayTokensForOwnerAndNetwork)(connection, owner, gatekeeperNetwork, includeRevoked);
