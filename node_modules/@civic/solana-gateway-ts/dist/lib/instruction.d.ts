...
declare class Issue extends Assignable {
    seed?: Uint8Array;
    expireTime?: number;
}
...
declare class ExpireToken extends Assignable {
    padding?: Uint8Array;
    gatekeeperNetwork: AssignablePublicKey;
}
declare class BurnToken extends Assignable {
}
 ...
 */
export declare function issue(gatewayTokenAccount: PublicKey, payer: PublicKey, gatekeeperAccount: PublicKey, owner: PublicKey, gatekeeperAuthority: PublicKey, gatekeeperNetwork: PublicKey, seed?: Uint8Array, expireTime?: number): TransactionInstruction;
/**
 ...
 */
export declare function expireToken(gatewayTokenAccount: PublicKey, owner: PublicKey, gatekeeperNetwork: PublicKey): TransactionInstruction;
/**
 ...
 */
export declare function burn(gatewayTokenAccount: PublicKey, gatekeeperAuthority: PublicKey, gatekeeperAccount: PublicKey, recipient: PublicKey): TransactionInstruction;
export {};
