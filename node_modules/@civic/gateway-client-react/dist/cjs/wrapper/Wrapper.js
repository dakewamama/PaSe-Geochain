...
const DefaultWrapper = ({ children = null, onClose, logo, loaded = false, loading = false, }) => {
    ...
    gateway_client_core_1.logger.debug('DefaultWrapper', { loaded, loading });
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({ style: Object.assign(Object.assign({}, containerStyle), { position: 'fixed', flexDirection: 'column', zIndex: 999 }) }, { children: (0, jsx_runtime_1.jsxs)("div", Object.assign({ style: Object.assign(Object.assign(Object.assign({}, containerContentStyle), { flexDirection: 'column', position: 'relative' }), (loading ? { filter: 'contrast(0.5)', background: '#fff' } : {})) }, { children: [logo && loaded && ((0, jsx_runtime_1.jsx)("header", Object.assign({ style: Object.assign(Object.assign({}, headerStyle), { position: 'relative' }) }, { children: (0, jsx_runtime_1.jsx)("img", { style: logoStyle, src: logo, alt: "logo" }) }))), !logo && loaded && isCI && (0, jsx_runtime_1.jsx)("div", { style: cypressStyle }), !loaded && (0, jsx_runtime_1.jsx)(SVGLoading_1.default, {}), (0, jsx_runtime_1.jsx)("button", Object.assign({ "data-testid": constants_1.TESTID_IFRAME_CLOSE_BTN, type: "button", onClick: onClose, style: Object.assign(Object.assign({}, closeButtonStyle), { display: loaded ? 'block' : 'none', position: 'absolute' }) }, { children: (0, jsx_runtime_1.jsx)(SVGClose_1.default, {}) })), children] })) })));
};
// eslint-disable-next-line import/prefer-default-export
const Wrapper = ({ wrapper, onClose, children = null, logo, loaded = false, loading = false, }) => {
    if (wrapper) {
    ...
    return ((0, jsx_runtime_1.jsx)(DefaultWrapper, Object.assign({ onClose: onClose, logo: logo, loaded: loaded, loading: loading }, { children: children })));
};
