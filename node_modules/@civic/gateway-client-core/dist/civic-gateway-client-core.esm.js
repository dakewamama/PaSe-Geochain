...
var validationProcessToGatewayStatus = (_a$2 = {},
    _a$2[ValidationStatus.COLLECTING] = GatewayStatus.COLLECTING_USER_INFORMATION,
    _a$2[ValidationStatus.PROCESSING] = GatewayStatus.VALIDATING_USER_INFORMATION,
    _a$2[ValidationStatus.IN_REVIEW] = GatewayStatus.VALIDATING_USER_INFORMATION,
    _a$2[ValidationStatus.FAILED] = GatewayStatus.USER_INFORMATION_REJECTED,
    _a$2[ValidationStatus.COMPLETED] = GatewayStatus.USER_INFORMATION_VALIDATED,
    _a$2);
...
var statusIfGatekeeperRecordRejected = function (state) {
    ...
    switch (recordState) {
        case GatekeeperAPIStatus.ISSUED_EXPIRED:
            return (gatewayToken === null || gatewayToken === void 0 ? void 0 : gatewayToken.received) ? undefined : GatewayStatus.ERROR;
...
var Orchestrator = (function () {
    ...
    Orchestrator.prototype.onInternalStatusChange = function (status, previousStatus) {
        ...
        if ([ExtendedGatewayStatus.RESTART, ExtendedGatewayStatus.RESTART_REFRESH].includes(status)) {
            return this.reset();
        }
    };
...
var gatewayStatusToCivicPassAction = (_a$1 = {},
    _a$1[GatewayStatus.IN_REVIEW] = CivicPassMessageAction.TOKEN_IN_REVIEW,
    _a$1[GatewayStatus.ERROR] = CivicPassMessageAction.ERROR,
    _a$1[GatewayStatus.ACTIVE] = CivicPassMessageAction.TOKEN_ACTIVE,
    _a$1[GatewayStatus.REVOKED] = CivicPassMessageAction.TOKEN_REVOKED,
    _a$1[GatewayStatus.FROZEN] = CivicPassMessageAction.TOKEN_FROZEN,
    _a$1[GatewayStatus.REJECTED] = CivicPassMessageAction.TOKEN_REJECTED,
    _a$1[GatewayStatus.LOCATION_NOT_SUPPORTED] = CivicPassMessageAction.TOKEN_REJECTED,
    _a$1[GatewayStatus.VPN_NOT_SUPPORTED] = CivicPassMessageAction.TOKEN_REJECTED,
    _a$1[GatewayStatus.REFRESH_TOKEN_REQUIRED] = CivicPassMessageAction.REFRESH,
    _a$1[GatewayStatus.CHECKING] = CivicPassMessageAction.STATUS,
    _a$1[GatewayStatus.UNKNOWN] = CivicPassMessageAction.ISSUANCE,
    _a$1[GatewayStatus.NOT_REQUESTED] = CivicPassMessageAction.ISSUANCE,
    _a$1[GatewayStatus.COLLECTING_USER_INFORMATION] = CivicPassMessageAction.ISSUANCE,
    _a$1[GatewayStatus.VALIDATING_USER_INFORMATION] = CivicPassMessageAction.ISSUANCE,
    _a$1[GatewayStatus.USER_INFORMATION_VALIDATED] = CivicPassMessageAction.ISSUANCE,
    _a$1[GatewayStatus.USER_INFORMATION_REJECTED] = CivicPassMessageAction.ISSUANCE,
    _a$1[ExtendedGatewayStatus.USER_VALIDATION_FAILED] = CivicPassMessageAction.ISSUANCE,
    _a$1[ExtendedGatewayStatus.ISSUANCE_RESTART_DATA_COLLECTION] = CivicPassMessageAction.ISSUANCE,
    _a$1[ExtendedGatewayStatus.ISSUANCE_AWAITING_TRANSACTION_SEND] = CivicPassMessageAction.SIGN_TRANSACTION,
    _a$1[ExtendedGatewayStatus.ISSUANCE_AWAITING_THIRD_PARTY_TRANSACTION_SEND] = CivicPassMessageAction.TOKEN_IN_REVIEW,
    _a$1[ExtendedGatewayStatus.ISSUANCE_CLIENT_PAYER_REQUESTED] = CivicPassMessageAction.SIGN_TRANSACTION,
    _a$1[ExtendedGatewayStatus.ISSUANCE_AWAITING_ON_CHAIN_TOKEN] = CivicPassMessageAction.AWAITING_TRANSACTION_CONFIRMATION,
    _a$1[ExtendedGatewayStatus.CONFIRM_OWNER_TRANSACTION] = CivicPassMessageAction.SIGN_TRANSACTION,
    _a$1[ExtendedGatewayStatus.AWAITING_OWNER_TRANSACTION] = CivicPassMessageAction.AWAITING_TRANSACTION_CONFIRMATION,
    _a$1[ExtendedGatewayStatus.CHAIN_TIMEOUT_ERROR] = CivicPassMessageAction.CHAIN_ERROR,
    _a$1[ExtendedGatewayStatus.CHAIN_TRANSACTION_ERROR] = CivicPassMessageAction.CHAIN_ERROR,
    _a$1[ExtendedGatewayStatus.CHAIN_SIGN_MESSAGE_ERROR] = CivicPassMessageAction.CHAIN_ERROR,
    _a$1[ExtendedGatewayStatus.TOKEN_IN_PARTNER_REVIEW] = CivicPassMessageAction.TOKEN_IN_PARTNER_REVIEW,
    _a$1[ExtendedGatewayStatus.TOKEN_REFRESH_IN_REVIEW] = CivicPassMessageAction.TOKEN_REFRESH_IN_REVIEW,
    _a$1[ExtendedGatewayStatus.REFRESH_AWAITING_TRANSACTION_SEND] = CivicPassMessageAction.SIGN_TRANSACTION,
    _a$1[ExtendedGatewayStatus.REFRESH_CLIENT_PAYER_REQUESTED] = CivicPassMessageAction.SIGN_TRANSACTION,
    _a$1[ExtendedGatewayStatus.REFRESH_AWAITING_ON_CHAIN_TOKEN] = CivicPassMessageAction.AWAITING_TRANSACTION_CONFIRMATION,
    _a$1[ExtendedGatewayStatus.REFRESH_USER_INFORMATION_VALIDATED] = CivicPassMessageAction.REFRESH,
    _a$1[ExtendedGatewayStatus.RESTART] = CivicPassMessageAction.ISSUANCE,
    _a$1[ExtendedGatewayStatus.REFRESH_IN_REVIEW] = CivicPassMessageAction.REFRESH,
    _a$1[ExtendedGatewayStatus.RESTART_REFRESH] = CivicPassMessageAction.REFRESH,
    _a$1[ExtendedGatewayStatus.REFRESH_AWAITING_THIRD_PARTY_TRANSACTION_SEND] = CivicPassMessageAction.TOKEN_REFRESH_IN_REVIEW,
    _a$1[ExtendedGatewayStatus.ISSUANCE_CLIENT_SENDS_START_NEW_TX] = CivicPassMessageAction.START_PRE_APPROVED_TRANSACTION,
    _a$1[ExtendedGatewayStatus.REFRESH_CLIENT_SENDS_START_NEW_TX] = CivicPassMessageAction.START_PRE_APPROVED_TRANSACTION,
    _a$1[ExtendedGatewayStatus.ISSUANCE_CLIENT_SENDS_REQUEST_NEW_TX] = CivicPassMessageAction.SIGN_TRANSACTION,
    _a$1[ExtendedGatewayStatus.REFRESH_CLIENT_SENDS_REQUEST_NEW_TX] = CivicPassMessageAction.SIGN_TRANSACTION,
    _a$1[ExtendedGatewayStatus.ISSUANCE_CLIENT_THIRD_PARTY_SENDS_REQUEST_NEW_TX] = CivicPassMessageAction.TOKEN_IN_REVIEW,
    _a$1[ExtendedGatewayStatus.REFRESH_CLIENT_THIRD_PARTY_SENDS_REQUEST_NEW_TX] = CivicPassMessageAction.TOKEN_REFRESH_IN_REVIEW,
    _a$1);
...
var flowTypeFromState = function (state, computedInternalStatus) {
    ...
    if ((_a = state.inputs.gatewayToken) === null || _a === void 0 ? void 0 : _a.received) {
        ...
        if ((_g = (_f = state.output) === null || _f === void 0 ? void 0 : _f.flowParameters) === null || _g === void 0 ? void 0 : _g.flowId.toLowerCase().includes(FlowType.REFRESH.toLowerCase())) {
            return FlowType.REFRESH;
        }
        if ((_j = (_h = state.output) === null || _h === void 0 ? void 0 : _h.flowParameters) === null || _j === void 0 ? void 0 : _j.flowId.toLowerCase().includes(FlowType.ISSUANCE.toLowerCase())) {
            return FlowType.ISSUANCE;
        }
        return FlowType.STATUS;
    }
    if ([GatewayStatus.CHECKING, GatewayStatus.UNKNOWN].includes(computedInternalStatus)) {
        return FlowType.STATUS;
    }
    return FlowType.ISSUANCE;
};
...
var flowStatusFromState = function (state, computedInternalStatus) {
    ...
    if ((previousStatus === GatewayStatus.CHECKING && initialFlowResultStatuses.includes(computedInternalStatus)) ||
        ...
        (previousStatus === GatewayStatus.ACTIVE && ((_c = (_b = state.inputs) === null || _b === void 0 ? void 0 : _b.dynamicParameters) === null || _c === void 0 ? void 0 : _c.forceRequireRefresh))) {
...
var transitions = (_a = {},
    _a[GatewayStatus.UNKNOWN] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [GatewayStatus.CHECKING], false), checkForInProgress),
    _a[GatewayStatus.CHECKING] = createTransition(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), errorStatuses, true), validationProcessStatuses, true), [
    ...
    _a[GatewayStatus.NOT_REQUESTED] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), validationProcessStatuses, true), [
        ExtendedGatewayStatus.TOKEN_IN_PARTNER_REVIEW,
    ...
    _a[GatewayStatus.COLLECTING_USER_INFORMATION] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), validationProcessStatuses, true), [
        ExtendedGatewayStatus.TOKEN_IN_PARTNER_REVIEW,
        ExtendedGatewayStatus.ISSUANCE_AWAITING_ON_CHAIN_TOKEN,
        GatewayStatus.NOT_REQUESTED,
        ExtendedGatewayStatus.RESTART,
    ...
    _a[GatewayStatus.USER_INFORMATION_VALIDATED] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [ExtendedGatewayStatus.ISSUANCE_CLIENT_PAYER_REQUESTED, GatewayStatus.IN_REVIEW], false), computeIssuanceRequested),
    _a[ExtendedGatewayStatus.ISSUANCE_CLIENT_PAYER_REQUESTED] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), errorStatuses, true), [
        ExtendedGatewayStatus.ISSUANCE_RESTART_DATA_COLLECTION,
        ExtendedGatewayStatus.ISSUANCE_AWAITING_TRANSACTION_SEND,
        ExtendedGatewayStatus.ISSUANCE_AWAITING_THIRD_PARTY_TRANSACTION_SEND,
        ExtendedGatewayStatus.ISSUANCE_AWAITING_ON_CHAIN_TOKEN,
    ...
    _a[GatewayStatus.IN_REVIEW] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), errorStatuses, true), [
        ExtendedGatewayStatus.ISSUANCE_AWAITING_TRANSACTION_SEND,
        ExtendedGatewayStatus.ISSUANCE_AWAITING_THIRD_PARTY_TRANSACTION_SEND,
        ExtendedGatewayStatus.ISSUANCE_AWAITING_ON_CHAIN_TOKEN,
        ExtendedGatewayStatus.TOKEN_IN_PARTNER_REVIEW,
    ], false), computeIssuanceInReview),
    _a[GatewayStatus.REJECTED] = createTransition([], function () { return GatewayStatus.REJECTED; }),
    _a[ExtendedGatewayStatus.ISSUANCE_AWAITING_TRANSACTION_SEND] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [
        ExtendedGatewayStatus.ISSUANCE_AWAITING_ON_CHAIN_TOKEN,
        ExtendedGatewayStatus.CONFIRM_OWNER_TRANSACTION,
        ExtendedGatewayStatus.CHAIN_TRANSACTION_ERROR,
    ], false), computeIssuanceInReview),
    _a[ExtendedGatewayStatus.ISSUANCE_AWAITING_THIRD_PARTY_TRANSACTION_SEND] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [
        ExtendedGatewayStatus.ISSUANCE_AWAITING_ON_CHAIN_TOKEN,
        ExtendedGatewayStatus.CONFIRM_OWNER_TRANSACTION,
        ExtendedGatewayStatus.CHAIN_TRANSACTION_ERROR,
    ], false), computeIssuanceInReview),
    _a[ExtendedGatewayStatus.ISSUANCE_AWAITING_ON_CHAIN_TOKEN] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [ExtendedGatewayStatus.CHAIN_TIMEOUT_ERROR], false), computeIssuanceAwaitingOnChainToken),
    _a[ExtendedGatewayStatus.ISSUANCE_RESTART_DATA_COLLECTION] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), validationProcessStatuses, true), [
        GatewayStatus.USER_INFORMATION_VALIDATED,
        ExtendedGatewayStatus.ISSUANCE_CLIENT_PAYER_REQUESTED,
        GatewayStatus.NOT_REQUESTED,
    ], false), computeIssuanceDataCollectionRestart),
    _a[GatewayStatus.REVOKED] = createTransition([], handleGatewayTokenExistsStatus),
    _a[GatewayStatus.FROZEN] = createTransition(__spreadArray([], gatewayTokenStatuses, true), handleGatewayTokenExistsStatus),
    _a[GatewayStatus.ACTIVE] = createTransition(__spreadArray([], gatewayTokenStatuses, true), handleGatewayTokenExistsStatus),
    _a[GatewayStatus.ERROR] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [ExtendedGatewayStatus.RESTART, ExtendedGatewayStatus.RESTART_REFRESH], false), handleGatekeeperError),
    _a[GatewayStatus.LOCATION_NOT_SUPPORTED] = createTransition([], function () { return GatewayStatus.LOCATION_NOT_SUPPORTED; }),
    _a[GatewayStatus.VPN_NOT_SUPPORTED] = createTransition([], function () { return GatewayStatus.VPN_NOT_SUPPORTED; }),
    _a[ExtendedGatewayStatus.USER_VALIDATION_FAILED] = createTransition([ExtendedGatewayStatus.USER_VALIDATION_FAILED, ExtendedGatewayStatus.RESTART], handleUserValidationFailed),
    _a[GatewayStatus.REFRESH_TOKEN_REQUIRED] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [
        ExtendedGatewayStatus.REFRESH_USER_INFORMATION_VALIDATED,
        ExtendedGatewayStatus.REFRESH_CLIENT_SENDS_START_NEW_TX,
    ], false), computeRefreshStatus),
    _a[ExtendedGatewayStatus.REFRESH_USER_INFORMATION_VALIDATED] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [
        ExtendedGatewayStatus.REFRESH_CLIENT_PAYER_REQUESTED,
        ExtendedGatewayStatus.REFRESH_IN_REVIEW,
    ], false), computeRefreshRequested),
    _a[ExtendedGatewayStatus.REFRESH_IN_REVIEW] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), errorStatuses, true), [
        ExtendedGatewayStatus.REFRESH_AWAITING_TRANSACTION_SEND,
        ExtendedGatewayStatus.REFRESH_AWAITING_THIRD_PARTY_TRANSACTION_SEND,
        ExtendedGatewayStatus.REFRESH_AWAITING_ON_CHAIN_TOKEN,
    ], false), computeRefreshInReview),
    _a[ExtendedGatewayStatus.TOKEN_REFRESH_IN_REVIEW] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), errorStatuses, true), [
        ExtendedGatewayStatus.REFRESH_AWAITING_TRANSACTION_SEND,
        ExtendedGatewayStatus.REFRESH_AWAITING_THIRD_PARTY_TRANSACTION_SEND,
        ExtendedGatewayStatus.REFRESH_AWAITING_ON_CHAIN_TOKEN,
    ], false), computeRefreshInReview),
    _a[ExtendedGatewayStatus.REFRESH_CLIENT_PAYER_REQUESTED] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), errorStatuses, true), [
        ExtendedGatewayStatus.REFRESH_AWAITING_TRANSACTION_SEND,
        ExtendedGatewayStatus.REFRESH_AWAITING_THIRD_PARTY_TRANSACTION_SEND,
        ExtendedGatewayStatus.REFRESH_AWAITING_ON_CHAIN_TOKEN,
    ], false), computeRefreshInReview),
    _a[ExtendedGatewayStatus.REFRESH_AWAITING_TRANSACTION_SEND] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [
        ExtendedGatewayStatus.REFRESH_AWAITING_ON_CHAIN_TOKEN,
        ExtendedGatewayStatus.CONFIRM_OWNER_TRANSACTION,
        ExtendedGatewayStatus.CHAIN_TRANSACTION_ERROR,
    ], false), computeRefreshInReview),
    _a[ExtendedGatewayStatus.REFRESH_AWAITING_THIRD_PARTY_TRANSACTION_SEND] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [
        ExtendedGatewayStatus.REFRESH_AWAITING_ON_CHAIN_TOKEN,
        ExtendedGatewayStatus.CONFIRM_OWNER_TRANSACTION,
        ExtendedGatewayStatus.CHAIN_TRANSACTION_ERROR,
    ], false), computeRefreshInReview),
    _a[ExtendedGatewayStatus.REFRESH_AWAITING_ON_CHAIN_TOKEN] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), errorStatuses, true), [ExtendedGatewayStatus.CHAIN_TIMEOUT_ERROR], false), computeRefreshAwaitingOnChainToken),
    _a[ExtendedGatewayStatus.CHAIN_TIMEOUT_ERROR] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [
        GatewayStatus.USER_INFORMATION_VALIDATED,
        ExtendedGatewayStatus.RESTART,
    ...
    _a[ExtendedGatewayStatus.CHAIN_TRANSACTION_ERROR] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [
        ExtendedGatewayStatus.RESTART,
        ExtendedGatewayStatus.RESTART_REFRESH,
        ExtendedGatewayStatus.ISSUANCE_AWAITING_TRANSACTION_SEND,
        ExtendedGatewayStatus.ISSUANCE_AWAITING_THIRD_PARTY_TRANSACTION_SEND,
    ...
    _a[ExtendedGatewayStatus.TOKEN_IN_PARTNER_REVIEW] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), errorStatuses, true), [ExtendedGatewayStatus.ISSUANCE_AWAITING_ON_CHAIN_TOKEN], false), computeIssuanceInReview),
    _a[ExtendedGatewayStatus.RESTART] = createTransition([ExtendedGatewayStatus.RESTART], function () { return ExtendedGatewayStatus.RESTART; }),
    _a[ExtendedGatewayStatus.RESTART_REFRESH] = createTransition([ExtendedGatewayStatus.RESTART_REFRESH], function () { return ExtendedGatewayStatus.RESTART_REFRESH; }),
    _a[ExtendedGatewayStatus.CHAIN_SIGN_MESSAGE_ERROR] = createTransition([
        ExtendedGatewayStatus.RESTART,
        ExtendedGatewayStatus.RESTART_REFRESH,
        ExtendedGatewayStatus.ISSUANCE_CLIENT_SENDS_REQUEST_NEW_TX,
        ExtendedGatewayStatus.ISSUANCE_CLIENT_THIRD_PARTY_SENDS_REQUEST_NEW_TX,
    ...
    _a[GatewayStatus.VALIDATING_USER_INFORMATION] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), validationProcessStatuses, true), [
        ExtendedGatewayStatus.TOKEN_IN_PARTNER_REVIEW,
        ExtendedGatewayStatus.RESTART,
        ExtendedGatewayStatus.ISSUANCE_AWAITING_ON_CHAIN_TOKEN,
        ExtendedGatewayStatus.ISSUANCE_RESTART_DATA_COLLECTION,
    ...
    _a[GatewayStatus.USER_INFORMATION_REJECTED] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), validationProcessStatuses, true), [
        ExtendedGatewayStatus.TOKEN_IN_PARTNER_REVIEW,
        ExtendedGatewayStatus.RESTART,
        ExtendedGatewayStatus.ISSUANCE_AWAITING_ON_CHAIN_TOKEN,
        ExtendedGatewayStatus.ISSUANCE_RESTART_DATA_COLLECTION,
    ...
    _a[ExtendedGatewayStatus.AWAITING_OWNER_TRANSACTION] = createTransition([], function () { return ExtendedGatewayStatus.AWAITING_OWNER_TRANSACTION; }),
    _a[ExtendedGatewayStatus.CONFIRM_OWNER_TRANSACTION] = createTransition([], function () { return ExtendedGatewayStatus.CONFIRM_OWNER_TRANSACTION; }),
    _a[ExtendedGatewayStatus.ISSUANCE_CLIENT_SENDS_START_NEW_TX] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [
        ExtendedGatewayStatus.ISSUANCE_CLIENT_SENDS_REQUEST_NEW_TX,
        ExtendedGatewayStatus.ISSUANCE_CLIENT_THIRD_PARTY_SENDS_REQUEST_NEW_TX,
    ], false), computeIssuanceStartPreApprovedTransaction),
    _a[ExtendedGatewayStatus.ISSUANCE_CLIENT_SENDS_REQUEST_NEW_TX] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), errorStatuses, true), [
        ExtendedGatewayStatus.ISSUANCE_RESTART_DATA_COLLECTION,
        ExtendedGatewayStatus.ISSUANCE_AWAITING_TRANSACTION_SEND,
        ExtendedGatewayStatus.ISSUANCE_AWAITING_THIRD_PARTY_TRANSACTION_SEND,
        ExtendedGatewayStatus.ISSUANCE_AWAITING_ON_CHAIN_TOKEN,
    ...
    _a[ExtendedGatewayStatus.ISSUANCE_CLIENT_THIRD_PARTY_SENDS_REQUEST_NEW_TX] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), errorStatuses, true), [
        ExtendedGatewayStatus.ISSUANCE_RESTART_DATA_COLLECTION,
        ExtendedGatewayStatus.ISSUANCE_AWAITING_TRANSACTION_SEND,
        ExtendedGatewayStatus.ISSUANCE_AWAITING_THIRD_PARTY_TRANSACTION_SEND,
        ExtendedGatewayStatus.ISSUANCE_AWAITING_ON_CHAIN_TOKEN,
    ...
    _a[ExtendedGatewayStatus.REFRESH_CLIENT_SENDS_START_NEW_TX] = createTransition(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), [
        ExtendedGatewayStatus.REFRESH_CLIENT_SENDS_REQUEST_NEW_TX,
        ExtendedGatewayStatus.REFRESH_CLIENT_THIRD_PARTY_SENDS_REQUEST_NEW_TX,
    ], false), computeRefreshStartPreApprovedTransaction),
    _a[ExtendedGatewayStatus.REFRESH_CLIENT_SENDS_REQUEST_NEW_TX] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), errorStatuses, true), [
        ExtendedGatewayStatus.REFRESH_AWAITING_TRANSACTION_SEND,
        ExtendedGatewayStatus.REFRESH_AWAITING_THIRD_PARTY_TRANSACTION_SEND,
        ExtendedGatewayStatus.REFRESH_AWAITING_ON_CHAIN_TOKEN,
    ], false), computeRefreshInReview),
    _a[ExtendedGatewayStatus.REFRESH_CLIENT_THIRD_PARTY_SENDS_REQUEST_NEW_TX] = createTransition(__spreadArray(__spreadArray(__spreadArray([], gatewayTokenStatuses, true), errorStatuses, true), [
        ExtendedGatewayStatus.REFRESH_AWAITING_TRANSACTION_SEND,
        ExtendedGatewayStatus.REFRESH_AWAITING_THIRD_PARTY_TRANSACTION_SEND,
        ExtendedGatewayStatus.REFRESH_AWAITING_ON_CHAIN_TOKEN,
    ], false), computeRefreshInReview),
...
var computeFlowParameters = function (state, computedInternalStatus) {
    ...
    if (!(((_a = state.inputs.parameters) === null || _a === void 0 ? void 0 : _a.wallet) && ((_b = state.internal.chainDetails) === null || _b === void 0 ? void 0 : _b.chainType) && ((_c = state.internal) === null || _c === void 0 ? void 0 : _c.instanceId)) ||
        [GatewayStatus.UNKNOWN, GatewayStatus.CHECKING].includes(computedInternalStatus)) {
        return null;
    }
...
var computeUiState = function (state, flowStatus, flowParameters) {
    ...
    if (flowStatus === FlowStatus.RESULT && (options === null || options === void 0 ? void 0 : options.autoShowModal)) {
        calculatedIsVisible = true;
    }
...
var computeState = function (state) {
    ...
    var computedUserInteractionStatus = [FlowStatus.RESULT, FlowStatus.FINISHED].includes(flowStatus) &&
...
export { ChainError, ChainType, ErrorCode, ExtendedGatewayStatus, FlowStatus, FlowType, GKN_SERVICE_ENDPOINTS, GatekeeperClient, GatewayStatus, SignatureMethod, State, TokenState, GatewayClientCore as default, getGatekeeperEndpoint, getGatekeeperNetworkData, getInstanceInputObject, hasRequiredInputs, localLogger as logger, prefixLogger, sendAnalyticsEvent, sendOnCloseAnalyticsEvent, shouldUpdateInstance };
//# sourceMappingURL=civic-gateway-client-core.esm.js.map
