 ...
 */
export declare const findGatewayToken: (connection: Connection, owner: PublicKey, gatekeeperNetwork: PublicKey, includeRevoked?: boolean) => Promise<GatewayToken | null>;
/**
